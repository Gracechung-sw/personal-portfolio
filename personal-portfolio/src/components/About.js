  ...
  <div className="about_compo">
    ...
    <div className="profile">
      ...
      <p className="profile-content">
        ...
        치료법이 개발되지 않은 여러 뇌 신경 질환에 대해서 다학제적 접근 방식을 논의해보는 학업
        시간을 가졌습니다. 인간의 지각, 행동, 의사결정, 정서 등 고등정신기능과 관련된 마음 및 행동의
        근간인 뇌를 이해하고있으며, 이를 데이터 분석를 통해 통해 얻은 insight와 융합하여 무한한
        영역에서 활용가능하게 하고자 하는 목표가 있습니다. 끊임없는 배움을 지향하며 이 과정속에서
        ‘자기주도적 몰두’와 ‘활발한 커뮤니케이션을 동반한 협력’ 의 중요성을 많이 경험하고
        습득하였습니다. 긍정적인 마음가짐을 가진 도전과 활발한 커뮤니케이션을 동반한 협력의 힘을
        믿고 있고, 그런 사람이 되려고 합니다.
      </p>
    </div>
  </div>
)
